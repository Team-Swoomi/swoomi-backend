...
@Slf4j
@RestController
@Api(tags = {"5. Champion Cooldown Information"})
...
public class ChampionInfoController {
    ...
    public SingleResult<ChampionCoolInfoDto> findChampionDefaultCooltimeInfo(
        ...
        ChampionCoolInfoDto championCoolInfoDto =
                championInfoService.getInitialCooltimeInfo(summonerName, matchTeamCode, ultLevel);
